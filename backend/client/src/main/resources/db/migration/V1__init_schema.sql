...
CREATE TABLE IF NOT EXISTS mapping_risque_activite (
    ...
    id_sous_activite     BIGINT       REFERENCES sous_activite(id_sous_activite),
    id_niveau            BIGINT,
...
CREATE UNIQUE INDEX idx_client_email       ON clients(email);
CREATE UNIQUE INDEX idx_client_national_id ON clients(national_id);
CREATE UNIQUE INDEX idx_client_cbs_id      ON clients(cbs_id);
...
(13,97100,'CROPS PROCESSING',NULL),
(14,97100,'MILLING',NULL),
(15,97100,'GRAIN STORAGE',NULL),
(20,97100,'OAT',NULL),
(25,97100,'CUCUMBER',NULL),
(26,97100,'CABBAGE',NULL),
(34,97100,'LEMON AND CITRUS',NULL),
(36,97100,'AVOCADO',NULL),
(47,97200,'BEER PRODUCTION',NULL),
(48,97200,'WINE PRODUCTION',NULL),
(52,97200,'MEAT PACKAGING',NULL),
(53,97200,'FISH PACKAGING',NULL),
(54,97200,'VEGETABLE PACKAGING',NULL),
(55,97300,'TEXTILE DYEING',NULL),
(56,97300,'SPINNING',NULL),
(57,97300,'KNITTING',NULL),
(58,97300,'APPAREL MANUFACTURING',NULL),
(64,99000,'PHARMACEUTICAL PRODUCTS',NULL),
(71,97300,'METALLIC FURNITURE',NULL),
(80,97300,'ZINC WORKING',NULL),
(81,97300,'ALUMINUM WORKING',NULL),
(82,97300,'COPPER WORKING',NULL),
(83,97300,'OTHER METAL WORKING',NULL),
(168,99100,'TAXI SERVICES',NULL),
(169,99100,'BUS SERVICES',NULL),
(170,99100,'MINIBUS SERVICES',NULL),
(173,99200,'TRUCK TRANSPORT',NULL),
(190,99400,'GYM AND FITNESS',NULL),
(198,99400,'SPORTS FACILITIES',NULL),
(199,99400,'ENTERTAINMENT VENUES',NULL);
