            ...
            <thead>
              ...
              <tr className="bg-white dark:bg-surface-800 border-b-2 border-surface-200 dark:border-surface-700">
                <td className="px-3 py-2">
                  <input value={colFilters.nomCC} onChange={e => setCol("nomCC", e.target.value)} placeholder={t("filters.searchPlaceholder")} className={filterInputClass} />
                </td>
                <td className="px-3 py-2">
                  <input value={colFilters.idClient} onChange={e => setCol("idClient", e.target.value)} placeholder={t("filters.idClientPlaceholder")} className={filterInputClass} />
                </td>
                <td className="px-3 py-2">
                  <input value={colFilters.nom} onChange={e => setCol("nom", e.target.value)} placeholder={t("filters.searchPlaceholder")} className={filterInputClass} />
                </td>
                <td className="px-3 py-2">
                  <input value={colFilters.idDemande} onChange={e => setCol("idDemande", e.target.value)} placeholder={t("filters.idDemandePlaceholder")} className={filterInputClass} />
                </td>
                <td className="px-3 py-2">
                  <select value={colFilters.statut} onChange={e => setCol("statut", e.target.value)} className={filterInputClass}>
                ...
                <td className="px-3 py-2">
                  <input value={colFilters.montant} onChange={e => setCol("montant", e.target.value)} placeholder={t("filters.montantPlaceholder")} className={filterInputClass} />
                </td>
                <td className="px-3 py-2">
                  <input value={colFilters.secteur} onChange={e => setCol("secteur", e.target.value)} placeholder={t("filters.secteurPlaceholder")} className={filterInputClass} />
                </td>
                <td className="px-3 py-2" />
                <td className="px-3 py-2" />
                <td className="px-3 py-2" />
                ...
                filteredDemandes.map(d => (
                  <tr key={d.id} className="hover:bg-surface-50 dark:hover:bg-surface-700/30 transition-colors">
                    <td className="px-3 py-3 whitespace-nowrap">
                      <span className="text-sm font-medium text-surface-900 dark:text-surface-50">{d.managerName || "—"}</span>
                    </td>
                    <td className="px-3 py-3 whitespace-nowrap">
                    ...
                    <td className="px-3 py-3 whitespace-nowrap">
                      <span className="text-sm text-surface-900 dark:text-surface-50">{displayClient(d)}</span>
                    </td>
                    <td className="px-3 py-3 whitespace-nowrap">
                      <span className="font-mono text-xs font-semibold text-surface-700 dark:text-surface-300">{d.id}</span>
                    </td>
                    <td className="px-3 py-3 whitespace-nowrap">
                      <Badge variant={statusVariant(d.status)}>{commonT(getStatusKey(d.status))}</Badge>
                    </td>
                    <td className="px-3 py-3 whitespace-nowrap">
                      <span className="text-sm font-medium text-surface-900 dark:text-surface-50">{formatAmount(d.requestedAmount)}</span>
                    </td>
                    <td className="px-3 py-3 max-w-[160px]">
                      <span className="text-xs text-surface-600 dark:text-surface-400 line-clamp-2">{d.businessSector || d.loanPurpose || "—"}</span>
                    </td>
                    <td className="px-3 py-3 whitespace-nowrap">
                      <span className="text-xs text-surface-600 dark:text-surface-400">{d.productName || d.productId || "—"}</span>
                    </td>
                    <td className="px-3 py-3 whitespace-nowrap">
                      <span className="text-xs text-surface-600 dark:text-surface-400">{d.cycle ?? "—"}</span>
                    </td>
                    <td className="px-3 py-3 whitespace-nowrap">
                      <span className="text-xs text-surface-500 dark:text-surface-400">{formatDate(d.createdAt)}</span>
                    </td>
                    <td className="px-3 py-3 whitespace-nowrap">
