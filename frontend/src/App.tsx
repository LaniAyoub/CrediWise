...
const GestionnairesPage = lazy(
  () => import("./pages/gestionnaires/GestionnairesPage"),
);
const ClientsPage = lazy(() => import("./pages/clients/ClientsPage"));
const ClientSearchPage = lazy(() => import("./pages/clients/Clientsearchpage"));
        ...
        <Suspense fallback={<PageLoader />}>
          <Routes>
            ...
            <Route element={<ProtectedRoute />}>
              ...
              <Route path="/ClientSerarch" element={<ClientSearchPage />} />
